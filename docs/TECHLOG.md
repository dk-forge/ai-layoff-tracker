...
**The question.** SEC Item 2.05 gold-set recall is 24/57. The 2026-08-01 entry
...
sweep with the model, against a $10/month allowance and a $0.20 per-run ceiling
(one month's sweep = $0.084, 42% of one run).
...
already hold. It is right 24 times and wrong 25. The employers in the miss list
...
same reasoning as the 2026-08-01 entry. Four surfaces unchanged: no collector
