...
def _default_preamble() -> str:
    return (
        ...
        "`railway/alert_outbox.json` (committed, so it outlives the runner) "
        "and delivered by the next `alert-drain` run that reaches the host.\n\n"
...
def repo_from_env(default: str = "dk-forge/ai-layoff-tracker") -> str:
