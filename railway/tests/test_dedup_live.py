...
#: Re-exported so the name reads the same at every call site below. The
#: definition moved to tests/_incident_free.py on 2026-09-09, when a second test
#: module needed it and could not import a helper private to this one.
_without_open_incidents = without_open_incidents
