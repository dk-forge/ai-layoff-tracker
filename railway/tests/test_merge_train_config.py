...
class TheWiring(unittest.TestCase):
    ...
    def test_the_config_loads(self):
        self.assertEqual(self.cfg.repo, "dk-forge/ai-layoff-tracker")
    ...
    def test_the_invariants_are_never_healed(self):
        for name in ("data-integrity", "Data integrity invariants",
                     "live-surface-check"):
    ...
    def test_the_workflow_never_uses_auto_merge(self):
        ...
        self.assertNotIn("--auto", (ROOT / "railway" / "merge_train.py")
