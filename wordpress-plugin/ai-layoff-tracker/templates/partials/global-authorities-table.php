...
$alt_authorities = array(
  ...
  'Europe' => array(
    ...
    array('France', 'Ministry of Labour / DREETS (PSE)', 'https://travail-emploi.gouv.fr', '⚠️ Partial (large layoffs only)', 'Eurofound ERM + reviewed news (data live)'),
  ...
  'Asia-Pacific' => array(
    ...
    array('Singapore', 'Ministry of Manpower', 'https://www.mom.gov.sg', '⚠️ Partial (large layoffs only)', 'Reviewed national news outlets'),
    array('South Korea', 'Ministry of Employment & Labor', 'https://www.moel.go.kr', '❌ Confidential filing', 'Reviewed national news outlets'),
    array('Taiwan', 'Ministry of Labor', 'https://www.mol.gov.tw', '⚠️ Partial (large layoffs only)', 'Reviewed national news outlets'),
