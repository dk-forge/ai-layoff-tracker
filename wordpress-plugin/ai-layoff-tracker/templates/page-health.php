...
<main class="alt-wrap alt-health-page" id="alt-health-page">
  ...
  <section class="alt-health-section alt-feature-list" id="alt-sec-roadmap" aria-labelledby="alt-feature-list-heading">
    ...
    <div class="alt-feature-grid">
      <article><span class="alt-health-status alt-health-active">Active</span><h3>Source-linked entry records</h3><p>Every published entry keeps its cited filing, government notice, company statement or named report; a single layoff can produce several entries and each keeps its own reports.</p></article>
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>Deduplication and lifecycle review</h3><p>When several outlets cover the same layoff, we combine them into one entry and keep every source link. When an announced cut looks like it later actually happened, an editor reviews the match before anything changes.</p></article>
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>High-impact editorial review</h3><p>We surface very large, AI-primary and multi-country entries for source-based review. We never correct one automatically behind the scenes.</p></article>
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>How complete our coverage is (spot-checked)</h3><p>The first published sample: California WARN, June 2026: 11 of 12 official notices, transcribed independently, matched a tracker entry (91.7% sample recall), checked by three independent reviewers against the sealed official notice. A sample is a spot measurement, never a completeness claim; further country-period samples follow the same protocol.</p></article>
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>Company layoff directory</h3><p>Pages live at /company-layoffs/ and grow automatically. An indexer admits every employer with a clean identity and at least one source-linked entry that we count in its own right, rather than folding into a larger one. The same server rules that govern manual review validate each one. We list an employer with two or more such entries in the sitemap. An employer below that keeps its page and stays noindex, because the page repeats what the individual entry already says.</p></article>
