...
<main class="alt-wrap alt-health-page" id="alt-health-page">
  ...
  <section class="alt-health-section alt-feature-list" id="alt-sec-roadmap" aria-labelledby="alt-feature-list-heading">
    ...
    <div class="alt-feature-grid">
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>Company layoff directory</h3><p>Pages live at /company-layoffs/ and grow automatically: a weekly autopilot admits companies with three or more source-linked canonical events and a clean identity, validated by the same server rules as manual review. Indexable pages are listed in the sitemap; below-threshold pages stay noindex.</p></article>
