...
<main class="alt-wrap alt-health-page" id="alt-health-page">
  ...
  <section class="alt-health-section" id="alt-sec-indexnow">
    ...
    <p>New data is pushed to Bing (which powers ChatGPT search) and Yandex automatically, at most once a day, whenever the dataset changes. Nothing here needs doing by hand; it is shown so you can verify in Bing Webmaster Tools.</p>
  ...
  <section class="alt-health-section alt-feature-list" id="alt-sec-roadmap" aria-labelledby="alt-feature-list-heading">
    ...
    <div class="alt-feature-grid">
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>How we decide a layoff is AI-related</h3><p>Employer-stated cause, contributing mention, background context and outright denial are kept separate. A model helps extract the text, but exact source quotes and fixed rules decide what gets published.</p></article>
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>US announcement reconciliation (internal)</h3><p>A monthly, like-for-like US employer / announcement / AI-primary reconciliation is computed internally to monitor coverage; tracker totals are never changed to match it.</p></article>
      ...
      <article><span class="alt-health-status alt-health-in_progress">In progress</span><h3>Adding announcement dates and company headquarters</h3><p>Company-headquarters data shipped July 19, 2026 from a checked, source-verifiable registry; it powers the US-employer views. Announcement dates are still being added daily from stored evidence; unknown fields stay blank rather than guessed.</p></article>
      ...
      <article><span class="alt-health-status alt-health-pending_permission">Pending review</span><h3>Official national and company IR connectors</h3><p>The first five reviewed company-owned IR feeds (Intel, SAP, Cisco, Salesforce, Micron) were admitted to the versioned registry on July 18, 2026. Japan EDINET and South Korea OpenDART discovery probes were retired after months live yielded zero layoff rows (those filings essentially never announce layoffs); Japan and South Korea are covered through worldwide news instead. We only mark a country as covered once its data feed has been built and reviewed.</p></article>
      ...
      <article><span class="alt-health-status alt-health-active">Active</span><h3>Company layoff directory</h3><p>Pages live at /company-layoffs/ and grow automatically: an indexer admits every employer with at least one source-linked canonical event and a clean identity, validated by the same server rules as manual review. An employer with two or more such events is listed in the sitemap; one below that keeps its page and stays noindex, because that page repeats what the individual entry already says.</p></article>
      <article><span class="alt-health-status alt-health-active">Active</span><h3>Quarterly State of Layoffs report</h3><p>The query-backed HTML report is published from an immutable server-generated snapshot, with its data revision and coverage limits disclosed.</p></article>
