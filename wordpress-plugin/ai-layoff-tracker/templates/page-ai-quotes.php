...
<main class="alt-wrap alt-qw">
  ...
  <div class="alt-qw-summary">
    <b><?php echo number_format($alt_total); ?></b> AI attributions<?php echo $alt_total > $LIMIT ? ' (showing the ' . $LIMIT . ' most recent)' : ''; ?> · <b><?php echo number_format($alt_jobs); ?></b> jobs · each with the employer's quote and its source.
  </div>
