...
<div class="alt-wrap alt-dashboard">
    ...
    <div class="alt-chart-grid">
        ...
        <div class="alt-chart-card">
            <h3>Top 10 industries <span class="alt-chart-sub">by total job losses</span></h3>
        ...
        <div class="alt-chart-card alt-chart-card-wide">
            <h3>Cumulative AI-attributed job losses <span class="alt-chart-sub">acceleration curve</span></h3>
            <div class="alt-chart-box"><canvas id="alt-chart-ai-cumulative"></canvas></div>
        </div>
        <div class="alt-chart-card">
            <h3>Top 10 countries <span class="alt-chart-sub">by total job losses</span></h3>
            <div class="alt-chart-box alt-chart-box-tall"><canvas id="alt-chart-countries"></canvas></div>
        </div>
        <div class="alt-chart-card">
            <h3>Largest single events <span class="alt-chart-sub">all time</span></h3>
