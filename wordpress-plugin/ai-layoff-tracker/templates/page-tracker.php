...
<div class="alt-wrap alt-tracker-wrap alt-dashboard">
    ...
    <details class="alt-methodology">
        ...
        <div class="alt-method-body">
            ...
            <p><b>Why our totals differ from other headline numbers.</b> Government statistics (BLS) count <em>every</em> separation in the economy, millions per month, with no event-level detail. Announcement surveys (Challenger, Gray &amp; Christmas; the WSJ and TrueUp trackers) count corporate <em>intentions</em>, including estimates, cuts absorbed by attrition, and multi-year plans. This tracker counts only cuts with a <em>verifiable document or quoted primary source behind them</em>, so its totals sit well below announcement surveys on purpose. Treat our figures as a documented floor: smaller than the estimates, but every single number is clickable back to a legal filing or named outlet.</p>
