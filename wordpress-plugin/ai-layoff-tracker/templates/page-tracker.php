...
<div class="alt-wrap alt-tracker-wrap alt-dashboard">
    ...
    <details class="alt-methodology">
        ...
        <div class="alt-method-body">
            <p>Different trackers measure different things. The factual differences, so you can pick the right number for your purpose:</p>
            <p><b><a href="https://www.challengergray.com/press/press-releases/" target="_blank" rel="noopener">Challenger, Gray &amp; Christmas</a></b> — monthly totals of <em>announced</em> US job cuts compiled from press reports and company statements, including estimates and multi-year plans. Published as monthly press releases; no per-event public database. Because announcements exceed executed cuts, Challenger's totals run above any verified-event count, including ours.</p>
            <p><b><a href="https://www.wsj.com/economy/jobs" target="_blank" rel="noopener">WSJ layoffs coverage</a></b> — editorially selected major announcements with newsroom verification. No downloadable dataset; coverage is selective by design.</p>
            <p><b><a href="https://www.trueup.io/layoffs" target="_blank" rel="noopener">TrueUp</a></b> and <b><a href="https://layoffs.fyi" target="_blank" rel="noopener">Layoffs.fyi</a></b> — technology-sector trackers built from announcements and crowdsourced reports, downloadable. Their scope corresponds to our <em>Technology industry</em> filter, not our all-industry total.</p>
            <p><b>Official statistics</b> — <a href="https://www.bls.gov/jlt/" target="_blank" rel="noopener">US BLS JOLTS</a> (all separations economy-wide, millions per month), <a href="https://www.ons.gov.uk/employmentandlabourmarket/peoplenotinwork/redundancies" target="_blank" rel="noopener">UK ONS redundancies</a>, <a href="https://ec.europa.eu/eurostat" target="_blank" rel="noopener">Eurostat</a> — survey-based aggregates with no company-level detail. Event trackers measure a different universe and will not match them.</p>
            <p><b>This tracker</b> — verified events only in the headline totals (filings and sourced reports, each linked), announcement-stage figures in a separately labeled tier, corrections disclosed automatically below, data and code public. When our number differs from a tracker above, the difference is definitional; both definitions are stated here so either number can be used correctly.</p>
        </div>
    </details>
    ...
    <details class="alt-methodology">
        ...
        <div class="alt-method-body">
            <p><b>United States</b> — <a href="https://efts.sec.gov/LATEST/search-index?q=%22reduction%20in%20force%22&dateRange=custom&forms=8-K" target="_blank" rel="noopener">SEC EDGAR full-text search</a> (8-K filings, searched twice daily, 12 layoff phrasings); official state <b>WARN notices from 41 states</b>, imported daily — the complete per-state list of portals and parsers is public in <a href="https://github.com/dk-forge/ai-layoff-tracker/blob/main/railway/sources/warn.py" target="_blank" rel="noopener">our source code</a> (the remaining states publish no usable per-notice data: HI and OK omit headcounts; MO and NM publish nothing).</p>
            <p><b>European Union, Norway (and UK historically)</b> — the <a href="https://apps.eurofound.europa.eu/restructuring-events/" target="_blank" rel="noopener">European Restructuring Monitor</a> (Eurofound, EU agency): per-company restructuring announcements compiled by national correspondents screening 58 designated business media daily, imported daily with attribution. ERM records announcement-stage figures, so its entries feed our Announced tier.</p>
            <p><b>Worldwide, all countries</b> — the <a href="https://blog.gdeltproject.org/gdelt-doc-2-0-api-debuts/" target="_blank" rel="noopener">GDELT global news index</a>, which machine-translates press coverage from 65+ languages (Le Monde, Handelsblatt, Nikkei, Globo and thousands more) — searched twice daily for layoff coverage in any country — plus <a href="https://newsapi.org" target="_blank" rel="noopener">NewsAPI</a>. Only articles from an editorially maintained trusted-outlet list are ingested; that list is also public in the repository.</p>
            <p><b>What the AI does and does not do</b> — WARN and ERM records are imported with <em>no AI processing</em> (they are already structured). For press articles, the DeepSeek-V3 model extracts the company, count, date, country and any explicit AI attribution from the article text; countries and industries then normalize through fixed vocabularies, counts and dates pass hard validation rules, and duplicates are checked against the existing data. A second, independent model pass audits classifications daily (plus a monthly full-dataset audit); label corrections apply only when two independent passes agree, numeric changes and removals always require a human, and every correction self-discloses in the log below.</p>
            <p><b>Known gaps, stated plainly</b> — a few countries publish official per-company redundancy records we do not yet ingest (Belgium's FPS Employment collective-dismissal reports, Italy's weekly CIGS decree lists, Sweden's varsel statistics); they are on the roadmap. Most countries (including Germany and Mexico) treat employer identity in redundancy filings as confidential, so press coverage — via GDELT in local languages — is the primary source there. Events too small for any press coverage, WARN threshold, or ERM threshold (≥100 jobs) will not appear in any tracker, including this one.</p>
        </div>
    </details>
