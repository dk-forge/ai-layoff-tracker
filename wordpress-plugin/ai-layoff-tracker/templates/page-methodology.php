...
<main class="alt-wrap alt-method-page">
  ...
  <section class="alt-method-sec" id="m-cards">
    ...
    <p><b>What this is.</b> A continuously updated, source-linked database of publicly reported layoffs worldwide. It records the source, evidence quote, event status and revision history, so anyone can check every figure independently. It does not claim complete coverage in every country.</p>
  </section>
  ...
  <section class="alt-method-sec" id="m-coverage">
    ...
    <p><b>What we leave out.</b> Rumored or unsourced layoffs. Layoffs with no stated job count. Forward-looking projections, such as "could cost X jobs by 2050," rather than announced or executed cuts. Look-back summary articles that would double-count events we already track.</p>
