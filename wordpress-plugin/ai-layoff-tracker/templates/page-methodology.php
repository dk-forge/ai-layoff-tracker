...
<main class="alt-wrap alt-method-page">
  ...
  */ ?>
  ...
  <section class="alt-method-sec" id="m-cards">
    ...
    <p><b>What &ldquo;verified&rdquo; does and does not claim.</b> It is the name of a tier, and the tier answers one question: is this cut source-linked rather than an announcement-stage estimate? It does <b>not</b> claim that we independently confirmed the number. It does not claim the employer stated it. How strong the evidence is behind a cut is a separate question, answered by its evidence tier below. That tier runs from a company&rsquo;s own filing down to a single named outlet&rsquo;s report. So a cut inside the Verified figure can still be one outlet reporting, with no document behind it yet. Where that is true we say so on the entry itself, in the table and in the email editions. We never describe such a cut as confirmed by the employer.</p>
